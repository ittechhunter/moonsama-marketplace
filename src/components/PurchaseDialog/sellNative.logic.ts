...
export const sellNative = (ppu?: BigNumber, total?: BigNumber, inputAmountText?: string, giveAssetDecimals=0, getAssetDecimals=0) => {
    ...
    userGet = sendAmount
    userGetDisplay = Fraction.from(userGet?.toString(), getAssetDecimals)?.toFixed(5);
